...
public class MovieServiceTest {
    ...
    public void testGetAllMovies() {
        ...
        Movie movie1 = new Movie("Movie 1", "Theatre 1", 120, 120, "Book now", null);
        Movie movie2 = new Movie("Movie 2", "Theatre 2", 150, 150, "Book now", null);
        movies.add(movie1);
        movies.add(movie2);
    ...
    void getMovieByName() {
        // Set up mock data
        List<Movie> movies = new ArrayList<>();
        movies.add(new Movie("Dasara", "Miraj", 126, 126, "Book ASAP", null));
        movies.add(new Movie("The Matrix", "Hollywood", 150, 150, "Experience the action", null));
        movies.add(new Movie("Inception", "Hollywood", 148, 148, "Your mind is the scene of the crime", null));
    ...
    void testFindAvailableTickets() {
        ...
        List<Movie> expectedMovies = Arrays.asList(
                new Movie("Avengers: Endgame", "Action", 180, 180, "Incredible!"),
                new Movie("Avengers: Endgame", "Action", 180, 180, "Amazing!"),
                new Movie("Avengers: Endgame", "Action", 180, 180, "Thrilling!")
        );
    ...
    @Test
    void testSaveMovie() {
        Movie expectedMovie = new Movie("Avengers: Endgame", "Action", 180, 180, "Incredible!");
    ...
    void findByMovieName() {
        ...
        List<Movie> movies = new ArrayList<>(List.of(
                new Movie("The Dark Knight", "Christopher Nolan", 152, 152, "A Batman movie"),
                new Movie("The Dark Knight Rises", "Christopher Nolan", 165, 165, "Another Batman movie")
        ));
